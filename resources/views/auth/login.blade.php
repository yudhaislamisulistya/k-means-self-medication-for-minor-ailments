                ...
                <div class="row no-gutters">
                    ...
                    <div class="col-md-6 position-relative">
                        <div class="sign-in-from">
                            ...
                            <p>Silahkan Masuk Untuk Dapat Mengakses Admin Panel</p>
                            <form method="POST" action="{{ route('login') }}">
                                ...
                                <div class="sign-info">
                                    <span class="dark-color d-inline-block line-height-2">Tidak Memiliki Akun? <a href="{{ route('register') }}">Daftar</a></span>
                                </div>
                            </form>
                        </div>
                    </div>
